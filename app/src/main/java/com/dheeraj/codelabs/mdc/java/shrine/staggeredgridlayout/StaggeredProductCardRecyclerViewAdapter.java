...
import com.dheeraj.codelabs.mdc.java.shrine.network.ImageRequester;
import com.dheeraj.codelabs.mdc.java.shrine.network.ProductEntry;
...
public class StaggeredProductCardRecyclerViewAdapter extends RecyclerView.Adapter<StaggeredProductCardViewHolder> {
    ...
    public StaggeredProductCardViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        int layoutId = com.dheeraj.codelabs.mdc.java.shrine.R.layout.shr_staggered_product_card_first;
        if (viewType == 1) {
            layoutId = com.dheeraj.codelabs.mdc.java.shrine.R.layout.shr_staggered_product_card_second;
        } else if (viewType == 2) {
            layoutId = com.dheeraj.codelabs.mdc.java.shrine.R.layout.shr_staggered_product_card_third;
        }
