package com.dheeraj.codelabs.mdc.java.shrine.network;
...
public class ProductEntry {
    ...
    public static List<ProductEntry> initProductEntryList(Resources resources) {
        InputStream inputStream = resources.openRawResource(com.dheeraj.codelabs.mdc.java.shrine.R.raw.products);
